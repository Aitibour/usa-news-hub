...
const logoSVG = `<span style="font-family:'Arial Black',Impact,sans-serif;font-size:22px;font-weight:900;font-style:italic;letter-spacing:-.5px;line-height:1"><span style="color:#1A5FCC">America</span><span style="color:#C8102E">Pulse</span><span style="display:inline-block;border:2.5px solid #1A5FCC;border-radius:6px;padding:1px 6px;margin-left:4px;font-size:14px;color:#1A5FCC;vertical-align:middle">.live</span></span>`;
const header = `
<div class="top-bar">
